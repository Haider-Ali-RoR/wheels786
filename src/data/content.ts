...
const en: ContentBundle = {
  ...
  fleet: [
    ...
    },
    {
      ...
      hourly: 50,
      badge: "Best Value",
      text: "A comfortable, elegant saloon for everyday transfers and city journeys. Smooth, discreet, and impeccably maintained — premium travel at our most accessible rate.",
      features: ["Leather interior", "Climate control", "Bottled water", "Phone chargers"],
    },
  ],
...
const fr: ContentBundle = {
  ...
  fleet: [
    ...
    },
    {
      ...
      hourly: 50,
      badge: "Meilleur prix",
      text: "Une berline élégante et confortable pour vos transferts quotidiens et trajets en ville. Douce, discrète et impeccablement entretenue — le voyage premium à notre tarif le plus accessible.",
      features: ["Intérieur cuir", "Climatisation", "Eau en bouteille", "Chargeurs de téléphone"],
    },
  ],
